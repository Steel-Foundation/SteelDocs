...
3. Minecraft-{VERSION}-Clients akzeptieren
...
Nachdem Steel läuft, gehe weiter zu [Configuration](/SteelDocs/getting-started/configuration/), um deinen Server anzupassen.