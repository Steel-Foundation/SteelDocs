...
Check in [our community](#community) for the latest updates.

## Servers to test steelmc

Currently only 2 servers which are running day and night to allow you to join and experience what works at steel and what not.
Please keep also in mind, steel is still pre-alpha, so either the file format nore all features are there.

- `steel.mrshadow.dev` (VPS: 4 vCores, 8GB RAM)
- `de1.papernodes.com:27006` (shared 7950x, 16GB RAM)
