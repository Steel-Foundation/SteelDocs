...
description: "Nine months into building a Minecraft server in Rust, SteelMC has block-for-block terrain parity, a multithreaded foundation, and a server you can try today."
...
Nine months into the project, Steel has matched vanilla block for block since May 20, 2026, across 7,500 randomly selected terrain-generation test chunks: 2,500 in each dimension.

Our [vanilla reference extractor](/development/tools/steel_extractor/) fixes generation order and normalizes a few order-dependent behaviors so those comparisons are reproducible. I explain those cases below.
